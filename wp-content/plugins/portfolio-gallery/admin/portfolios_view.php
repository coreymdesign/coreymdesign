							...
							<div class="image-options">
								<div class="options-container">
									...
									<div class="description-block">
										...
										<textarea id="im_description<?php echo $rowimages->id; ?>" name="im_description<?php echo $rowimages->id; ?>" ><?php echo htmlspecialchars($rowimages->description); ?></textarea>
									</div>
                                    ...
                                    jQuery(document).on('click', '#add_new_cat_buddon', function () {
                                       ...
                                       if(newCatVal !== "") {
                                           ...
                                           jQuery('.inside > ul').find('#allCategories').before(
                                                           "<li class='hndle'><input class='del_val' value='"+newCatVal+"' style=''>"+"<span id='delete_cat' style='' value='a'><img src='../wp-content/plugins/portfolio-gallery/images/delete1.png' width='9' height='9' value='a'>"+
                                                               "</span><span id='edit_cat' style=''><img src='../wp-content/plugins/portfolio-gallery/images/edit3.png' width='10' height='10'>"+
                                                                "</span></li>");
...
?>
	...
	<div id="huge_it_portfolio_add_posts">
					<div id="huge_it_portfolio_add_posts_wrap">
						<h2><?php echo __( 'Add post', 'portfolio-gallery' );?></h2>
						...
						<form method="post"  onkeypress="doNothing()" action="admin.php?page=portfolios_huge_it_portfolio&task=popup_posts&id=<?php echo $_GET['id']; ?>" id="huge-it-category-form" name="admin_form">
							<label for="huge-it-categories-list"><?php echo __( 'Select Category', 'portfolio-gallery' );?> <select id="huge-it-categories-list" name="iframecatid" onchange="this.form.submit()">
...
<?php
							...
							<button class='save-portfolio-options button-primary huge-it-insert-post-button' id='huge-it-insert-post-button-top'><?php echo __( 'Add Video Slide', 'portfolio-gallery' );?>Insert Posts</button>
							<label for="huge-it-description-length"><?php echo __( 'Description Length ', 'portfolio-gallery' );?><input id="huge-it-description-length" type="text" name="posthuge-it-description-length" value="<?php echo $row->published; ?>" placeholder="Description length" /></label>
							<div class="view-type-block">
								<a class="view-type list active" href="#list"><?php echo __( 'View List', 'portfolio-gallery' );?></a>
								<a class="view-type thumbs" href="#thumbs"><?php echo __( 'View List', 'portfolio-gallery' );?></a>
							</div>
						</div>
						<div style="clear:both;"></div>
						<ul id="huge-it-posts-list" class="list">
							<li id="huge-it-posts-list-heading" class="hascolor">
								<div class="huge-it-posts-list-image"><?php echo __( 'Image', 'portfolio-gallery' );?></div>
								<div class="huge-it-posts-list-title"><?php echo __( 'Title', 'portfolio-gallery' );?></div>
								<div class="huge-it-posts-list-description">
									<?php echo __( 'Description', 'portfolio-gallery' );?>
									
								</div>
								<div class="huge-it-posts-list-link"><?php echo __( 'Link', 'portfolio-gallery' );?></div>
								<div class="huge-it-posts-list-category"><?php echo __( 'Category', 'portfolio-gallery' );?></div>
							</li>
							<?php 
						...
						<div class="clear"></div>
						<button class='save-portfolio-options button-primary huge-it-insert-post-button' id='huge-it-insert-post-button-bottom'><?php echo __( 'Insert Posts', 'portfolio-gallery' );?></button>
						</form>
...
function Html_portfolio_video_edit($thumb,$id_portfolio,$id,$param,$video,$edit) {		
	global $wpdb;$video_id = get_video_id_from_url_portfolio($param);
