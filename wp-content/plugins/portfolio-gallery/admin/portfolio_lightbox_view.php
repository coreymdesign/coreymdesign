		...
		?>
			...
			<div>
				...
				<select id="light_box_transition" name="params[light_box_transition]">	
					<option <?php if($param_values['light_box_transition'] == 'elastic'){ echo 'selected="selected"'; } ?> value="elastic"><?php echo __( 'Save', 'portfolio-gallery' );?>Elastic</option>
					<option <?php if($param_values['light_box_transition'] == 'fade'){ echo 'selected="selected"'; } ?> value="fade"><?php echo __( 'Save', 'portfolio-gallery' );?>Fade</option>
					<option <?php if($param_values['light_box_transition'] == 'none'){ echo 'selected="selected"'; } ?> value="none"><?php echo __( 'Save', 'portfolio-gallery' );?>none</option>
				</select>
			</div>	
			<div class="has-background">
