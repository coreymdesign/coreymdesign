 ...
 ob_start();
	...
	$slidechangespeed=$portfolio[0]->param;
		...
		$image_prefix = "_huge_it_small_portfolio";
				/***<optimize_images>***/
		if($paramssld["port_natural_size_contentpopup"]=='resize'){
...
}else if($paramssld["port_natural_size_contentpopup"]=='natural'){
		if(!function_exists('get_huge_image')) {
		function get_huge_image($image_url) {
...
<?php } ?>
        <div id="huge_it_portfolio_container_<?php echo $portfolioID; ?>" class="super-list variable-sizes clearfix" <?php if($paramssld["ht_view0_sorting_float"] == "top" && $paramssld["ht_view0_filtering_float"] == "top") echo "style='clear: both;'";?>>
              ...
              foreach($images as $key=>$row)
              {
                      ...
                      ?>
                      <div class="portelement_<?php echo $portfolioID; ?> colorbox_grouping <?php foreach ($catForFilter as $catForFilterValue) { echo str_replace(" ","_",$catForFilterValue)." ";} ?>" data-symbol="<?php echo $row->name; ?>" data-category="alkaline-earth">
                                              ...
                                              <?php 	
											    if($row->image_url != ';'){
													switch(youtube_or_vimeo_portfolio($imgurl[0])) { 
														...
														<a href="https://www.youtube.com/embed/<?php echo $videourl[0];?>" class="huge_it_portfolio_item pyoutube portfolio-group<?php if( $lighboxable == "lighboxable")  echo $group_key;?> "  title = "<?php echo $row->name;?>">
													...
													?>
														<a href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" class="huge_it_portfolio_item pvimeo portfolio-group<?php if( $lighboxable == "lighboxable")  echo $group_key;?> "  title = "<?php echo $row->name;?>">
                                                      ...
                                                      <ul class="thumbs-list_<?php echo $portfolioID; ?>">
															...
															<?php 
																...
																case 'youtube':
                                                                    ...
                                                                    <a href="https://www.youtube.com/embed/<?php echo $videourl[0];?>" class="huge_it_portfolio_item pyoutube portfolio-group<?php echo $group_key;?> "  title = "<?php huge_it_title_img_display($img,$title);?>" style="position:relative">
															  ...
															  <?php 
																...
																case 'vimeo':
																	...
																	$hash = unserialize(file_get_contents("http://vimeo.com/api/v2/video/".$videourl[0].".php"));
																	$imgsrc=$hash[0]['thumbnail_large'];?>
																	<a class="huge_it_portfolio_item pvimeo portfolio-group<?php echo $group_key;?> " href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo $row->name; ?>"  style="position:relative">
    ...
    var $optionSets = jQuery('#huge_it_portfolio_options_<?php echo $portfolioID; ?> .option-set'),
	  ...
	  <?php }?>
		function centersection(){
				var count  = jQuery('.portelement_<?php echo $portfolioID; ?>').length;
                var elementwidth=<?php echo $paramssld['ht_view0_block_width']+10; ?> + <?php echo $paramssld['ht_view0_element_border_width']*2; ?>;
                var enterycontent=jQuery("#huge_it_portfolio_content_<?php echo $portfolioID; ?>").width();
                var whole=~~(enterycontent/(elementwidth));
				if(whole > count) whole= count;
                if(whole==0){ return false; }
                else { var sectionwidth = whole * elementwidth+(whole-1)*20;}
                jQuery("#huge_it_portfolio_container_<?php echo $portfolioID; ?>").width(sectionwidth).css({"margin":"0px auto","overflow":"hidden"});
                                              ...
                                              <?php
											    if($row->image_url != ';'){
													switch(youtube_or_vimeo_portfolio($imgurl[0])) { 
														...
														case 'youtube':
														$videourl=get_video_id_from_url_portfolio($imgurl[0]);?>
                                                        <a href="https://www.youtube.com/embed/<?php echo $videourl[0];?>" class="huge_it_portfolio_item pyoutube portfolio-group<?php echo $group_key;?>" title="<?php echo $row->name;?>">
															<img alt="<?php echo $row->name; ?>" id="wd-cl-img<?php echo $key; ?>"  src="//img.youtube.com/vi/<?php echo $videourl[0]; ?>/mqdefault.jpg"  />
															<div class="play-icon <?php echo $videourl[1];?>-icon"></div>
														</a>	
														<?php
														...
														$imgsrc=$hash[0]['thumbnail_large'];
													?>
														<a class="huge_it_portfolio_item pvimeo portfolio-group<?php echo $group_key;?> " href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo $row->name; ?>">
															<img alt="<?php echo $row->name; ?>" src="<?php echo $imgsrc; ?>"  />
															<div class="play-icon <?php echo $videourl[1];?>-icon"></div>
														</a>	
														<?php break;
...
var defaultBlockWidth=<?php echo $paramssld['ht_view1_block_width']; ?>;
    ...
    var $container = jQuery('#huge_it_portfolio_container_<?php echo $portfolioID; ?>');
      ...
      // add randomish size classes
      $container.find('.portelement_<?php echo $portfolioID; ?>').each(function(){//console.log("rand");
        var $this = jQuery(this),
            number = parseInt( $this.find('.number').text(), 10 );
			//alert(number);
        if ( number % 7 % 2 === 1 ) {
    ...
    $container.hugeitmicro({
	  ...
	  <?php }?>
		function centersection(){
				var count  = jQuery('.portelement_<?php echo $portfolioID; ?>').length;
                var elementwidth=<?php echo $paramssld['ht_view1_block_width']+10; ?> + <?php echo $paramssld['ht_view1_element_border_width']*2; ?>;
                var enterycontent=jQuery("#huge_it_portfolio_content_<?php echo $portfolioID; ?>").width();
                var whole=~~(enterycontent/(elementwidth));
				if(whole > count) whole= count;
                if(whole==0){ return false; }
...
var defaultBlockHeight=<?php echo $paramssld['ht_view2_element_height']; ?>;
    ...
    $container.hugeitmicro({//
	  ...
	  <?php }?>
		function centersection(){
				var count  = jQuery('.portelement_<?php echo $portfolioID; ?>').length;
                var elementwidth=<?php echo $paramssld['ht_view2_element_width']+10; ?> + <?php echo $paramssld['ht_view2_element_border_width']*2; ?>;
                var enterycontent=jQuery("#huge_it_portfolio_content_<?php echo $portfolioID; ?>").width();
                var whole=~~(enterycontent/(elementwidth));
				if(whole > count) whole= count;
                if(whole==0){ return false; }
  ...
  jQuery(document).ready(function(){
	...
	jQuery('#huge_it_portfolio_popup_list_<?php echo $portfolioID; ?> .popup-wrapper_<?php echo $portfolioID; ?> .right-block ul.thumbs-list_<?php echo $portfolioID; ?> li ').on('click','a.img-thumb',function(){//console.log("filter");//thubnail neri meccnelna
        ...
        jQuery("#huge_it_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .left-change").click(function(){
            ...
            if(jQuery("#huge_it_portfolio_filters_<?php echo $portfolioID; ?> li[rel!='*'].active").attr("rel"))
                var active_rel = jQuery("#huge_it_portfolio_filters_<?php echo $portfolioID; ?> li[rel!='*'].active").attr("rel");
            else 
                var active_rel = "";
            if(jQuery(this).closest(".pupup-element").prevAll(".pupup-element"+active_rel).length){
            	...
            	var strid = jQuery("#huge_it_portfolio_popup_list_<?php echo $portfolioID; ?>").find(".pupup-element"+active_rel+":last").find('a').data('popupid').replace('#','');
            	jQuery('#huge_it_portfolio_pupup_element_'+strid).css({height:height*0.7});
                jQuery(this).closest(".pupup-element").removeClass("active");
                jQuery("#huge_it_portfolio_popup_list_<?php echo $portfolioID; ?>").find(".pupup-element"+active_rel+":last").addClass("active");
            }
        ...
        jQuery("#huge_it_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .right-change").click(function(){
            ...
            if(jQuery("#huge_it_portfolio_filters_<?php echo $portfolioID; ?> li[rel!='*'].active").attr("rel"))
                ...
                var active_rel = "";
            var cnt = 0;
            jQuery("#huge_it_portfolio_popup_list_<?php echo $portfolioID; ?>").find(".pupup-element"+active_rel).each(function(){
                cnt++;
            });
            //alert(num+" "+cnt);
            if(jQuery(this).closest(".pupup-element").nextAll(".pupup-element"+active_rel).length){
            	...
            	var strid = jQuery("#huge_it_portfolio_popup_list_<?php echo $portfolioID; ?>").find(".pupup-element"+active_rel+":first a").data('popupid').replace('#','');	        	
	        	jQuery('#huge_it_portfolio_pupup_element_'+strid).css({height:height*0.7});
                jQuery(this).closest(".pupup-element").removeClass("active");
                jQuery("#huge_it_portfolio_popup_list_<?php echo $portfolioID; ?>").find(".pupup-element"+active_rel+":first").addClass("active");
            }
        });
	//////
...
#huge_it_portfolio_popup_list_<?php echo $portfolioID; ?> .popup-wrapper_<?php echo $portfolioID; ?> .image-block_<?php echo $portfolioID; ?> {
	width:60%;
        <?php if($paramssld['ht_view2_popup_full_width'] == 'off') { echo "height:100%;"; } else {echo "height:100%; overflow-y:scroll;";} ?>
	position:relative;
	float:left;
	margin-right:2%;
...
<?php } ?>
    <div id="huge_it_portfolio_container_<?php echo $portfolioID; ?>" class="super-list variable-sizes clearfix" <?php if($paramssld["ht_view2_sorting_float"] == "top" && $paramssld["ht_view2_filtering_float"] == "top") echo "style='clear: both;'";?> style="margin-top: 5px;">
              ...
              foreach($images as $key=>$row)
              {
                      ...
                      $catForFilter = explode(",", $row->category);
                      ?>
                      <div id="huge_it_portfolio_pupup_element_<?php echo $row->id; ?>_child" class="portelement_<?php echo $portfolioID; ?>  <?php foreach ($catForFilter as $catForFilterValue) { echo str_replace(" ","_",$catForFilterValue)." ";} ?>" tabindex="0" data-symbol="<?php echo $row->name; ?>" data-category="alkaline-earth">
...
<ul id="huge_it_portfolio_popup_list_<?php echo $portfolioID; ?>">
	...
	foreach($images as $key=>$row)
	{
		...
		$result = substr($descnohtml, 0, 50);
                $catForFilter = explode(",", $row->category);
		?>
		<li class="pupup-element <?php foreach ($catForFilter as $catForFilterValue) { echo str_replace(" ","_",$catForFilterValue)." ";} ?>" id="huge_it_portfolio_pupup_element_<?php echo $row->id; ?>">
...
jQuery(".portelement_<?php echo $portfolioID; ?> .image-block_<?php echo $portfolioID; ?> img").each(function(i, img) {
                              ...
                              <div class="left-block_<?php echo $portfolioID; ?>">
                                      <div class="main-image-block_<?php echo $portfolioID; ?> add-H-relative" >
											  ...
											  <?php break;
													...
													$hash = unserialize(file_get_contents("http://vimeo.com/api/v2/video/".$videourl[0].".php"));
													$imgsrc=$hash[0]['thumbnail_large'];?>
													<a class="huge_it_portfolio_item pvimeo portfolio-group<?php echo $group_key;?> add-H-block" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?> " title="<?php echo $row->name; ?>" >
														  ...
														  <?php
															  ...
															  case 'vimeo':
																   ...
																   $hash = unserialize(file_get_contents("http://vimeo.com/api/v2/video/".$videourl[0].".php"));
																	$imgsrc=$hash[0]['thumbnail_large'];?>
																	<li>
																	<a class="huge_it_portfolio_item pvimeo portfolio-group<?php echo $group_key;?>  add-H-relative" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo $row->name; ?>">
																		<img src="<?php echo $imgsrc; ?>" alt="<?php echo $row->name; ?>" /><div class="play-icon <?php echo $videourl[1];?>-icon"></div>
																	</a>
																	</li>																	
															  <?php
  ...
  $optionLinks.click(function(){
	...
	return false;
	  ...
	  <?php }?>
		function centersection(){
				var count  = jQuery('.portelement_<?php echo $portfolioID; ?>').length;
                var elementwidth=<?php echo $paramssld['ht_view4_block_width']+10; ?> + <?php echo $paramssld['ht_view4_element_border_width']*2; ?>;
                var enterycontent=jQuery("#huge_it_portfolio_content_<?php echo $portfolioID; ?>").width();
                var whole=~~(enterycontent/(elementwidth));
				if(whole > count) whole= count;
                if(whole==0){ return false; }
				...
				<div class="image-block_<?php echo $portfolioID; ?>">
					...
					if($row->image_url != ';')
					{
						...
						<?php 
							...
							case 'youtube':
							$videourl=get_video_id_from_url_portfolio($imgurl[0]);?>
								<a href="https://www.youtube.com/embed/<?php echo $videourl[0];?>" class="huge_it_portfolio_item pyoutube portfolio-group-slider_<?php echo $portfolioID;?>_<?php  echo $group_key1; ?> add-H-relative add-H-block"  title="<?php echo $row->name; ?>">
						...
						<?php
							...
							$imgsrc=$hash[0]['thumbnail_large'];
							?>
							<a class="huge_it_portfolio_item pvimeo portfolio-group-slider_<?php echo $portfolioID;?>_<?php  echo $group_key1; ?>   add-H-relative add-H-block" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo $row->name; ?>">
								<img src="<?php echo $imgsrc; ?>" alt="<?php echo $row->name; ?>" /><div class="play-icon <?php echo $videourl[1];?>-icon"></div>
							</a>
					<?php	break;	
						}
						...
						array_shift($imgurl);
								foreach($imgurl as $key=>$img)
								{
									switch(youtube_or_vimeo_portfolio($img)) {
										case 'image':
									?>
									<li><a class="portfolio-group-slider_<?php echo $portfolioID;?>_<?php  echo $group_key1; ?>" href="<?php echo $img; ?>" title = "<?php huge_it_title_img_display($img,$title);?>"><img src="<?php echo get_huge_image($img,$image_prefix); ?>"></a></li>
								<?php 
										break;
										case 'youtube':
										$videourl=get_video_id_from_url_portfolio($img);?>
										<li>
										<a href="https://www.youtube.com/embed/<?php echo $videourl[0];?>" class="huge_it_portfolio_item pyoutube portfolio-group-slider_<?php echo $portfolioID;?>_<?php  echo $group_key1; ?>  add-H-relative"  title = "<?php huge_it_title_img_display($img,$title);?>">
											<img src="//img.youtube.com/vi/<?php echo $videourl[0]; ?>/mqdefault.jpg"><div class="play-icon <?php echo $videourl[1];?>-icon"></div>
										</a>
										</li>	
									<?php
										...
										$imgsrc=$hash[0]['thumbnail_large'];?>
										<li>
										<a class="huge_it_portfolio_item pvimeo portfolio-group-slider_<?php echo $portfolioID;?>_<?php  echo $group_key1; ?>  add-H-relative" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?> " title="<?php echo $row->name; ?>"  style="position:relative">
											<img src="<?php echo $imgsrc; ?>" alt="<?php echo $row->name; ?>" /><div class="play-icon <?php echo $videourl[1];?>-icon"></div>
										</a>
										</li>
									<?php 
											...
											if($row->image_url != ';'){
												switch(youtube_or_vimeo_portfolio($imgurl[0])) { 
													...
													case 'youtube':
														...
														$videourl=get_video_id_from_url_portfolio($imgurl[0]);?>
														 <a href="https://www.youtube.com/embed/<?php echo $videourl[0];?>" class="huge_it_portfolio_item pyoutube  portfolio-lightbox-group<?php echo $portfolioID;?>"  title = "<?php echo $row->name;?>">
															<img alt="<?php echo $row->name; ?>" id="wd-cl-img<?php echo $key; ?>"  src="//img.youtube.com/vi/<?php echo $videourl[0]; ?>/mqdefault.jpg"  />
															<div class="play-icon <?php echo $videourl[1];?>-icon"></div>
														</a>
													<?php 
													...
													case 'vimeo':
														...
														$hash = unserialize(file_get_contents("http://vimeo.com/api/v2/video/".$videourl[0].".php"));
														$imgsrc=$hash[0]['thumbnail_large'];?>
														<a class="huge_it_portfolio_item pvimeo  portfolio-lightbox-group<?php echo $portfolioID;?>" href="http://player.vimeo.com/video/<?php echo $videourl[0]; ?>" title="<?php echo $row->name; ?>">
															<img src="<?php echo $imgsrc; ?>" alt="<?php echo $row->name; ?>" /><div class="play-icon vimeo-icon"></div>
														</a>
													<?php
													break;
    ...
    ////filteringgggggg
        ...
        jQuery(document).ready(function(){
            jQuery('#huge_it_portfolio_filters_<?php echo $portfolioID; ?> ul li').click(function() {
                ...
                filterValue = filterValue;//filterFns[ filterValue ] || 
                $container.hugeitmicro({ filter: filterValue });
                jQuery(".portelement_<?php echo $portfolioID; ?>").not(filterValue).find(".image-block_<?php echo $portfolioID; ?> a").removeClass("portfolio-lightbox-group<?php echo $portfolioID;?>").removeClass("pcboxElement");
                var lightbox_element = jQuery(".portelement_<?php echo $portfolioID; ?>"+filterValue).find(".image-block_<?php echo $portfolioID; ?> a");
                lightbox_element.each(function(){
                    if(!jQuery(this).hasClass("portfolio-lightbox-group<?php echo $portfolioID;?>")){
                        jQuery(this).addClass("portfolio-lightbox-group<?php echo $portfolioID;?>");
                    }
                    if(!jQuery(this).hasClass("pcboxElement")){
                        jQuery(this).addClass("pcboxElement");
                    }
                });
            });
